...
import RightMenu from "./demo";
import AppLayout from "./web";
import { useState } from "react";
import Footer from "../../footer/footer";
import bg1 from "../../assets/images/12bg.jpg"
import bg2 from "../../assets/images/24.jpg";import bg3 from "../../assets/images/25.jpg";
import bg4 from "../../assets/images/26.jpg";import bg5 from "../../assets/images/23.jpg";
...
document.addEventListener('click', ()=> {
        setval("hide"); //here you draw your own menu
                ...
                <div role="alert" className="container mx-auto mt-10 w-11/12 md:w-2/3 max-w-lg flex justify-center">
                    <div className="relative w-11/12 sm:w-8/12 md:w-9/12 bg-[#211F26] dark:bg-gray-800 shadow  pt-10 pb-8 rounded">
                        <div className="flex flex-col items-center px-4 md:px-12">
                            ...
                            <img
                  src={pp} class="flex-shrink-0 object-cover object-center btn- flex w-16 h-16 mr-auto -mb-8 ml-auto rounded-full shadow-xl"></img>
                ...
                <div role="alert" className="container mx-auto mt-10 w-11/12 md:w-2/3 max-w-lg flex justify-center">
                    <div className="relative w-11/12 sm:w-8/12 md:w-9/12 bg-[#211F26] dark:bg-gray-800 shadow  pt-10 pb-8 rounded">
                        <div className="flex  items-center px-6 md:px-12">
                            ...
                            <img
                  src={pp} class="flex-shrink-0 object-cover object-center btn- flex w-16 h-16 mr-auto -mb-6 ml-auto rounded-full shadow-xl"></img>
                             <div>
